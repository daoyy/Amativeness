!function (e) {
    ...
    "use strict";
    a(1), a(5);
    var n = a(7), r = a(8), o = a(9);
    $(document).ready(function (e) {
        function t() {
            window.setTimeout(function () {
                t()
            }, 1e3);
            var a = new Date("2/9/2014 11:30:00"), n = new Date, r = n.getTime() - a.getTime(), o = 864e5, l = r / o, s = Math.floor(l), i = 24 * (l - s), d = Math.floor(i), p = 60 * (i - d), m = Math.floor(60 * (i - d)), c = Math.floor(60 * (p - m));
        ...
        function a(e) {
            ...
            if (t) {
                e.preventDefault();
                var a = "著作权归作者所有。<br>商业转载请联系作者获得授权，非商业转载请注明出处。<br>作者：DIYgod<br>链接：" + window.location.href + "<br>来源：Anotherhome<br><br>" + window.getSelection().toString(), n = "著作权归作者所有。\n商业转载请联系作者获得授权，非商业转载请注明出处。\n作者：DIYgod\n链接：" + window.location.href + "\n来源：Anotherhome\n\n" + window.getSelection().toString();
                t.setData("text/html", a), t.setData("text/plain", n)
            }
        }

        function l() {
            b || (b = new Audio("https://dyy-file.b0.upaiyun.com/loli.mp3")), b.play()
        }

        function s(t) {
            if (t.find("img").lazyload({effect: "fadeIn"}), e(".post a").attr("target", "_blank"), t.find("#dplayer5").length) {
                new n({
                    ...
                    screenshot: !0,
                    video: {
                        url: "https://ogn7ujzqd.qnssl.com/wxwlive/1102/index.m3u8",
                        pic: "https://ogn7ujzqd.qnssl.com/wxwlive/1102/poster.png"
                    },
                    danmaku: {
                        id: "f171a0b104c1fd55",
                        ...
                        token: "tokendemo",
                        maximum: 3e3,
                        addition: ["https://ogn7ujzqd.qnssl.com/wxwlive/1102/danmaku.json"]
                    }
                })
            }
            if (t.find("#dplayer4").length) {
                new n({
                    ...
                    screenshot: !0,
                    video: {
                        url: "https://ogn7ujzqd.qnssl.com/wxwlive/1019/index.m3u8",
                        pic: "https://ogn7ujzqd.qnssl.com/wxwlive/1019/poster.png"
                    },
                    danmaku: {
                        id: "02d53ea190dc8583",
                        api: "https://api.prprpr.me/dplayer/",
                        token: "tokendemo",
                        maximum: 3e3,
                        addition: ["https://ogn7ujzqd.qnssl.com/wxwlive/1019/danmaku.json"]
                    }
                })
            }
            if (t.find("#dplayer3").length && !function () {
                    var e = new XMLHttpRequest;
                    e.onreadystatechange = function () {
                        if (4 === e.readyState)if (e.status >= 200 && e.status < 300 || 304 === e.status) {
                            ...
                            new n({
                                ...
                                preload: "none",
                                screenshot: !1,
                                video: {url: t.durl[0].url, pic: "https://ogn7ujzqd.qnssl.com/【微小微】玖月奇迹－踩踩踩.jpg"},
                                danmaku: {
                                    id: "18EE8C0B4653D5F4",
                                    api: "https://api.prprpr.me/dplayer/",
                                    token: "tokendemo",
                    ...
                    }, e.open("get", "https://api.prprpr.me/dplayer/video/bilibili?aid=2903742", !0), e.send(null)
                }(), t.find("#dplayer2").length && !function () {
                    var e = new XMLHttpRequest;
                    e.onreadystatechange = function () {
                        if (4 === e.readyState)if (e.status >= 200 && e.status < 300 || 304 === e.status) {
                            var t = JSON.parse(e.responseText);
                            new n({
                                ...
                                preload: "none",
                                screenshot: !1,
                                video: {url: t.durl[0].url, pic: "https://ogn7ujzqd.qnssl.com/微小微-江南皮革厂倒闭了.jpg"},
                                danmaku: {
                                    id: "5rGf5Y2X55qu6Z2p",
                                    api: "https://api.prprpr.me/dplayer/",
                                    token: "tokendemo",
                    ...
                    }, e.open("get", "https://api.prprpr.me/dplayer/video/bilibili?aid=4045652", !0), e.send(null)
                }(), t.find("#dplayer1").length && !function () {
                    var e = new XMLHttpRequest;
                    e.onreadystatechange = function () {
                        if (4 === e.readyState)if (e.status >= 200 && e.status < 300 || 304 === e.status) {
                            var t = JSON.parse(e.responseText);
                            new n({
                                ...
                                screenshot: !1,
                                preload: "none",
                                video: {url: t.durl[0].url, pic: "https://ogn7ujzqd.qnssl.com/若能绽放光芒.png"},
                                danmaku: {
                                    id: "9E2E3368B56CDBB4",
                                    api: "https://api.prprpr.me/dplayer/",
                                    token: "tokendemo",
                    ...
                    }, e.open("get", "https://api.prprpr.me/dplayer/video/bilibili?aid=1714157", !0), e.send(null)
                }(), t.find("#player1").length) {
                new APlayer({
            ...
            if (t.find("#player5").length) {
                new APlayer({
                    ...
                    music: {
                        title: "九九八十一",
                        author: "肥皂菌",
                        url: "https://dyy-file.b0.upaiyun.com/九九八十一.mp3",
                        pic: "https://dyy-file.b0.upaiyun.com/九九八十一.jpg",
            ...
            if (t.find("#player4").length) {
                new APlayer({
                    ...
                    music: {
                        title: "回レ！雪月花",
                        author: "小倉唯",
                        url: "https://dyy-file.b0.upaiyun.com/回レ！雪月花.mp3",
                        pic: "https://dyy-file.b0.upaiyun.com/回レ！雪月花.jpg",
            ...
            if (t.find("#player3").length) {
                new APlayer({
                    ...
                    music: {
                        ...
                        author: "茅野愛衣",
                        url: "https://dyy-file.b0.upaiyun.com/secretbase.mp3",
                        pic: "https://dyy-file.b0.upaiyun.com/secretbase.jpg",
            ...
            if (t.find("#player2").length) {
                new APlayer({
                    ...
                    music: {
                        ...
                        url: "https://dyy-file.b0.upaiyun.com/Preparation.mp3",
                        pic: "https://dyy-file.b0.upaiyun.com/Preparation.jpg"
                    }
                })
            }
        ...
        function i() {
            e("#comments-nav a").on("click", function (t) {
                return t.preventDefault(), NProgress.set(.7), jQuery.get(e(this).attr("href"), function (t) {
                    e(".commentshow").html(e(t).find(".commentshow")), NProgress.set(1), e("body, html").animate({scrollTop: e(".commentshow").offset().top - 120}, 1e3), i()
                }), !1
            })
        }
        ...
        if (e(".typed a").typed({
                ...
                e(t).click(function () {
                    ...
                    return e(this).addClass("active").siblings().removeClass("active"), e("html, body").animate({scrollTop: e(t).offset().top}, a), !1
                })
            }, e(window).width() > 800) {
            var p = e("#back-to-top"), m = e(window).height() - 980 + "px";
            e(window).scroll(function () {
                e(window).scrollTop() > 700 && "-900px" === p.css("top") ? p.css("top", m) : e(window).scrollTop() <= 700 && "-900px" !== p.css("top") && p.css("top", "-900px")
            })
        }
        ...
        var c, u = document.title;
        if (document.addEventListener("visibilitychange", function () {
                document.hidden ? (e('[rel="shortcut icon"]').attr("href", "//www.anotherhome.net/wp-content/themes/Amativeness/fail.ico"), document.title = "(●—●)喔哟，崩溃啦！", clearTimeout(c)) : (e('[rel="shortcut icon"]').attr("href", "//www.anotherhome.net/wp-content/themes/Amativeness/favicon.ico"), document.title = "(/≧▽≦/)咦！又好了！" + u, c = setTimeout(function () {
                    document.title = u
                }, 2e3))
                ...
                return e(this).addClass("loading").text("文章列表加载中..."), e.ajax({
                    ...
                    success: function (t) {
                        var a = e(t).find("#thumbs .post"), n = e(t).find("#pagination a").attr("href");
                        e("#thumbs").append(a.fadeIn(300)), s(a), e("#pagination a").removeClass("loading").text("点击加载更多"), void 0 != n ? e("#pagination a").attr("href", n) : e("#pagination").remove()
                    }
                }), !1
            ...
            var y = document.getElementsByClassName("navbar")[0], g = new r(y, {
                tolerance: 5,
                offset: 205,
                classes: {initial: "head-animated", pinned: "slideDown", unpinned: "slideUp"}
            });
            g.init()
        }
        for (var f = document.getElementsByClassName("article-content"), h = 0; h < f.length; h++)f[h].addEventListener("copy", function (e) {
        ...
        var v = e("#text-4"), x = e("#secondary"), w = e(window), k = x.offset().top + x.height();
        if (w.scroll(function () {
                w.scrollTop() > k ? v.css({
                    position: "fixed",
                    top: "40px",
                    width: "22%",
                    animation: "fade-in 0.5s"
                }) : v.css({position: "relative", top: "0", width: "initial", animation: "initial"})
            }), !d) {
            var Y, O, E, L, B, C, T, z, N, S, M, I;
            !function () {
                var e = function () {
                    for (O.clearRect(0, 0, L, B), T = [{x: 0, y: .7 * B + C}, {
                        x: 0,
                        y: .7 * B - C
                    }]; T[1].x < L + C;)t(T[0], T[1])
                }, t = function (e, t) {
                    O.beginPath(), O.moveTo(e.x, e.y), O.lineTo(t.x, t.y);
                    var n = t.x + (2 * I() - .25) * C, r = a(t.y);
                    O.lineTo(n, r), O.closePath(), N -= S / -50, O.fillStyle = "#" + (127 * M(N) + 128 << 16 | 127 * M(N + S / 3) + 128 << 8 | 127 * M(N + S / 3 * 2) + 128).toString(16), O.fill(), T[0] = T[1], T[1] = {
                        x: n,
                        y: r
                    }
                }, a = function n(e) {
                ...
                Y = document.getElementById("evanyou"), O = Y.getContext("2d"), E = window.devicePixelRatio || 1, L = window.innerWidth, B = window.innerHeight, C = 90, z = Math, N = 0, S = 2 * z.PI, M = z.cos, I = z.random, Y.width = L * E, Y.height = B * E, O.scale(E, E), O.globalAlpha = .6, document.onclick = e, document.ontouchstart = e, e()
            }()
        }
        if (document.getElementsByClassName("content-field").length && new o({
            ...
            for (var A = window.donateData.sort(function (e, t) {
                return e[0] > t[0] ? 1 : -1
            }), q = "", H = A.length - 1; H >= 0; H--)q += "\n                <tr>\n                    <td>" + A[H][0] + "</td>\n                    <td>" + A[H][1] + "</td>\n                    <td>" + A[H][2] + "</td>\n                </tr>\n            ";
            e(".donate-table tbody").append(q)
        }
        var D = jQuery("#cancel-comment-reply-link"), R = D.text(), j = "commentlist", P = {
        ...
        jQuery(document).on("submit", "#commentform", function () {
            return jQuery.ajax({
                ...
                beforeSend: function () {
                    F.createButterbar("正在提交,好累呀~"), NProgress.set(.7)
                },
                error: function (e) {
                    var t = F;
                    t.createButterbar(e.responseText), NProgress.set(1)
                },
                success: function (e) {
                    jQuery("textarea").each(function () {
                        this.value = ""
                    });
                    var t = F, a = t.I("cancel-comment-reply-link"), n = t.I("wp-temp-form-div"), r = t.I(t.respondId), o = (t.I("comment_post_ID").value, t.I("comment_parent").value);
                    "0" != o ? jQuery("#respond").before('<ol class="children">' + e + "</ol>") : jQuery("." + j).length ? "asc" == P.order ? jQuery("." + j).append(e) : jQuery("." + j).prepend(e) : "bottom" == P.formpostion ? jQuery("#respond").before('<ol class="' + j + '">' + e + "</ol>") : jQuery("#respond").after('<ol class="' + j + '">' + e + "</ol>"), t.createButterbar("提交"), NProgress.set(1), a.style.display = "none", a.onclick = null, t.I("comment_parent").value = "0", n && r && (n.parentNode.insertBefore(r, n), n.parentNode.removeChild(n))
                }
            }), !1
        });
        var F = {
            moveForm: function (e, t, a) {
                var n, r = this, o = r.I(e), l = r.I(a), s = r.I("cancel-comment-reply-link"), i = r.I("comment_parent");
                r.I("comment_post_ID");
                var temp;
                D.text(R), r.respondId = a, r.I("wp-temp-form-div") || (n = document.createElement("div"), n.id = "wp-temp-form-div", n.style.display = "none", l.parentNode.insertBefore(n, l)), o ? o.parentNode.insertBefore(l, o.nextSibling) : (temp = r.I("wp-temp-form-div"), r.I("comment_parent").value = "0", temp.parentNode.insertBefore(l, temp), temp.parentNode.removeChild(temp)), jQuery("body").animate({scrollTop: jQuery("#respond").offset().top - 180}, 400), i.value = t, s.style.display = "", s.onclick = function () {
                    var e = F, t = e.I("wp-temp-form-div"), a = e.I(e.respondId);
                    return e.I("comment_parent").value = "0", t && a && (t.parentNode.insertBefore(a, t), t.parentNode.removeChild(t)), this.style.display = "none", this.onclick = null, !1
                };
                try {
                    r.I("comment").focus()
                } catch (d) {
                ...
                document.getElementById("submit").value = e
            }
        };
        i()
    })
    ...
    function r(e) {
        for (var t = [], a = {}, n = 0; n < e.length; n++) {
            var r = e[n], o = r[0], l = r[1], s = r[2], i = r[3], d = {css: l, media: s, sourceMap: i};
    ...
    function o(e, t) {
        var a = f(), n = v[v.length - 1];
        if ("top" === e.insertAt)n ? n.nextSibling ? a.insertBefore(t, n.nextSibling) : a.appendChild(t) : a.insertBefore(t, a.firstChild), v.push(t); else {
    ...
    function p(e, t, a, n) {
        ...
        if (e.styleSheet)e.styleSheet.cssText = x(t, r); else {
            var o = document.createTextNode(r), l = e.childNodes;
    ...
    function c(e, t) {
        var a = t.css, n = t.sourceMap;
        n && (a += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(n)))) + " */");
        var r = new Blob([a], {type: "text/css"}), o = e.href;
        ...
        return function (e) {
            ...
            var l = 0, s = function () {
                function e(t) {
                    ...
                    var f = this.element.getElementsByClassName("dplayer-video-wrap")[0], h = this.element.getElementsByClassName("dplayer-controller-mask")[0];
                    if (s) {
                        var b = function () {
                    ...
                    var v = function (e) {
                        var t = function (e) {
                            return e < 10 ? "0" + e : "" + e
                        }, a = parseInt(e / 60), n = parseInt(e - 60 * a);
                        return t(a) + ":" + t(n)
                    }, x = function (e) {
                        var t = e.offsetLeft, n = e.offsetParent, r = void 0;
                        if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement)for (; null !== n && n !== a.element;)t += n.offsetLeft, n = n.offsetParent; else for (; null !== n;)t += n.offsetLeft, n = n.offsetParent;
                    ...
                    var k = this.element.getElementsByClassName("dplayer-bar-wrap")[0], Y = void 0;
                    ...
                    var O = 0, E = 0, L = !1, B = void 0;
                    this.setTime = function () {
                        a.playedTime = setInterval(function () {
                            E = a.video.currentTime, !L && E < O + .01 && !a.video.paused && (a.element.classList.add("dplayer-loading"), L = !0), L && E > O + .01 && !a.video.paused && (a.element.classList.remove("dplayer-loading"), L = !1), O = E, a.updateBar("played", a.video.currentTime / a.video.duration, "width"), a.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = v(a.video.currentTime), a.trigger("playing")
                    ...
                    var C = function (e) {
                        var t = e || window.event, n = (t.clientX - x(k)) / Y;
                        n = n > 0 ? n : 0, n = n < 1 ? n : 1, a.updateBar("played", n, "width"), a.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = v(n * a.video.duration)
                    }, T = function xe() {
                        document.removeEventListener("mouseup", xe), document.removeEventListener("mousemove", C), a.video.currentTime = parseFloat(w.playedBar.style.width) / 100 * a.video.duration, a.setTime()
                    };
                    ...
                    var z = this.element.getElementsByClassName("dplayer-volume")[0], N = this.element.getElementsByClassName("dplayer-volume-bar-wrap")[0], S = this.element.getElementsByClassName("dplayer-volume-bar")[0], M = this.element.getElementsByClassName("dplayer-volume-icon")[0], I = 35;
                    ...
                    var A = function (e) {
                        var t = e || window.event, n = (t.clientX - x(S) - 5.5) / I;
                        a.volume(n)
                    }, q = function we() {
                        document.removeEventListener("mouseup", we), document.removeEventListener("mousemove", A), z.classList.remove("dplayer-volume-active")
                    };
                    N.addEventListener("click", function (e) {
                        var t = e || window.event, n = (t.clientX - x(S) - 5.5) / I;
                        a.volume(n)
                    }), N.addEventListener("mousedown", function () {
                        document.addEventListener("mousemove", A), document.addEventListener("mouseup", q), z.classList.add("dplayer-volume-active")
                    ...
                    if (!s) {
                        var D = function () {
                            a.element.classList.remove("dplayer-hide-controller"), clearTimeout(H), H = setTimeout(function () {
                    ...
                    var R = localStorage.getItem("DPlayer-opacity") || .7, j = {
                    ...
                    }, P = this.element.getElementsByClassName("dplayer-setting-icon")[0], F = this.element.getElementsByClassName("dplayer-setting-box")[0], U = this.element.getElementsByClassName("dplayer-mask")[0];
                    F.innerHTML = j.original;
                    var X = function () {
                        F.classList.contains("dplayer-setting-box-open") && (F.classList.remove("dplayer-setting-box-open"), U.classList.remove("dplayer-mask-show"), setTimeout(function () {
                            F.classList.remove("dplayer-setting-box-narrow"), F.innerHTML = j.original, J()
                        }, 300))
                    }, V = function () {
                        F.classList.add("dplayer-setting-box-open"), U.classList.add("dplayer-mask-show")
                    };
                    ...
                    var Q = this.option.loop, _ = this.element.getElementsByClassName("dplayer-danmaku")[0], G = !0, J = function () {
                        var e = a.element.getElementsByClassName("dplayer-setting-loop")[0], t = e.getElementsByClassName("dplayer-toggle-setting-input")[0];
                        t.checked = Q, e.addEventListener("click", function () {
                            t.checked = !t.checked, t.checked ? (Q = !0, a.video.loop = Q) : (Q = !1, a.video.loop = Q), X()
                        });
                        var n = a.element.getElementsByClassName("dplayer-setting-showdan")[0], r = n.getElementsByClassName("dplayer-showdan-setting-input")[0];
                        r.checked = G, n.addEventListener("click", function () {
                            if (r.checked = !r.checked, r.checked) {
                                if (G = !0, a.option.danmaku) {
                                    for (var e = 0; e < a.dan.length; e++) {
                            ...
                            } else G = !1, a.option.danmaku && (clearInterval(B), _.innerHTML = '<div class="dplayer-danmaku-item  dplayer-danmaku-item--demo"></div>', a.danTunnel = {
                                right: {},
                                top: {},
                                bottom: {}
                        ...
                        o.addEventListener("click", function () {
                            F.classList.add("dplayer-setting-box-narrow"), F.innerHTML = j.speed;
                            for (var e = F.getElementsByClassName("dplayer-setting-speed-item"), t = function (t) {
                            ...
                            var e = a.element.getElementsByClassName("dplayer-danmaku-bar-wrap")[0], t = a.element.getElementsByClassName("dplayer-danmaku-bar")[0], n = a.element.getElementsByClassName("dplayer-setting-danmaku")[0], r = 130;
                            a.updateBar("danmaku", R, "width");
                            var o = function (e) {
                                var n = e || window.event, o = (n.clientX - x(t)) / r;
                    ...
                    J(), this.video.addEventListener("durationchange", function () {
                        1 !== a.video.duration && (a.element.getElementsByClassName("dplayer-dtime")[0].innerHTML = v(a.video.duration))
                        ...
                        a.updateBar("played", 1, "width"), Q || (a.ended = !0, a.pause(), a.trigger("ended"))
                    }), this.video.volume = parseInt(this.element.getElementsByClassName("dplayer-volume-bar-inner")[0].style.width) / 100, this.video.loop = Q, 1 !== this.video.duration && (this.element.getElementsByClassName("dplayer-dtime")[0].innerHTML = this.video.duration ? v(this.video.duration) : "00:00");
                    var W = y ? 24 : 30, K = void 0, Z = void 0, $ = void 0;
                    ...
                    var ee = function (e) {
                        ...
                        for (var o = K / te(n), l = function (n) {
                            ...
                            for (var l = 0; l < r.length; l++) {
                                var s = ee(r[l]) - 10;
                                if (s <= K - o * te(r[l].offsetWidth) || s <= 0)break;
                    ...
                    var ne = function (e, t, n) {
                        K = _.offsetWidth, Z = _.offsetHeight, $ = parseInt(Z / W);
                        ...
                        switch (n) {
                            case"right":
                                r.style.top = W * ae(r, n, o) + "px", r.style.width = o + 1 + "px", r.style.transform = "translateX(-" + K + "px)";
                                break;
                            case"top":
                                r.style.top = W * ae(r, n) + "px";
                                break;
                            case"bottom":
                                r.style.bottom = W * ae(r, n) + "px";
                                break;
                            default:
                    ...
                    var re = this.element.getElementsByClassName("dplayer-comment-input")[0], oe = this.element.getElementsByClassName("dplayer-comment-icon")[0], le = this.element.getElementsByClassName("dplayer-comment-box")[0], se = this.element.getElementsByClassName("dplayer-comment-setting-icon")[0], ie = this.element.getElementsByClassName("dplayer-comment-setting-box")[0], de = this.element.getElementsByClassName("dplayer-send-icon")[0], pe = function (e) {
                        ...
                        le.classList.contains("dplayer-comment-box-open") && (le.classList.remove("dplayer-comment-box-open"), U.classList.remove("dplayer-mask-show"), clearInterval(ye), a.element.classList.remove("dplayer-show-controller"), ce())
                    }, fe = function () {
                        le.classList.add("dplayer-comment-box-open"), U.classList.add("dplayer-mask-show"), ye = setInterval(function () {
                            clearTimeout(H)
                    ...
                    var be = function (e) {
                        var t = document.activeElement.tagName.toUpperCase(), n = document.activeElement.getAttribute("contenteditable");
                        if ("INPUT" !== t && "TEXTAREA" !== t && "" !== n && "true" !== n) {
                            var r = e || window.event, o = void 0;
                            switch (r.keyCode) {
                                case 32:
                    ...
                    var ve = this.element.getElementsByClassName("dplayer-menu")[0];
                    this.element.addEventListener("contextmenu", function (e) {
                        var t = e || window.event;
                        t.preventDefault(), ve.style.left = t.clientX - a.element.getBoundingClientRect().left + "px", ve.style.top = t.clientY - a.element.getBoundingClientRect().top + "px", ve.classList.add("dplayer-menu-show"), U.classList.add("dplayer-mask-show"), U.addEventListener("click", function () {
                            U.classList.remove("dplayer-mask-show"), ve.classList.remove("dplayer-menu-show")
                        })
            ...
            var n = a(2);
            "string" == typeof n && (n = [[e.id, n, ""]]), a(4)(n, {}), n.locals && (e.exports = n.locals)
        }, function (e, t, a) {
    ...
    !function (a, l) {
        ...
        return window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame, e.prototype = {
            ...
            constructor: r, init: function () {
                ...
                var t = e < 0, a = e + this.getScrollerPhysicalHeight() > this.getScrollerHeight();
                return t || a
            }, toleranceExceeded: function (e, t) {
                return Math.abs(e - this.lastKnownScrollY) >= this.tolerance[t]
            }, shouldUnpin: function (e, t) {
                var a = e > this.lastKnownScrollY, n = e >= this.offset;
                return a && n && t
            }, shouldPin: function (e, t) {
                var a = e < this.lastKnownScrollY, n = e <= this.offset;
                return a && t || n
            }, update: function () {
                var e = this.getScrollY(), t = e > this.lastKnownScrollY ? "down" : "up", a = this.toleranceExceeded(e, t);
                ...
                key: "init", value: function (e) {
                    ...
                    a += "\n                    </ul>\n                </div>\n            </div>\n            ", this.container.innerHTML = a, this.logo = this.container.getElementsByClassName("OwO-logo")[0], this.logo.addEventListener("click", function () {
                        ...
                        if (e.target.classList.contains("OwO-item") ? a = e.target : e.target.parentNode.classList.contains("OwO-item") && (a = e.target.parentNode), a) {
                            var n = t.area.selectionEnd, r = t.area.value;
